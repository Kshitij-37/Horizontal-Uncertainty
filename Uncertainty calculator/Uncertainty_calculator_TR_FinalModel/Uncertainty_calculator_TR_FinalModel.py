...
# Loads the ORIGINAL thesis-final JSON byte-for-byte (no re-fit) for exact reproducibility.
MODEL_JSON = os.path.join(_base_path(), "ws_uncertainty_pairlevel_results.json")
...
class CalculatorApp:
    def __init__(self, root):
        self.root = root
        self.root.title("WS Horizontal Extrapolation Uncertainty Calculator — Final model (exact thesis)")
    ...
    def _build_ui(self):
        ...
        ttk.Label(bottom_bar, text="TR_FinalModel (exact thesis-final, un-gated)",
