"""
Wind Speed Horizontal Extrapolation Uncertainty Calculator (TR_v2.0)
...
class CalculatorApp:
    ...
    def _build_ui(self):
        ...
        cols = ("wtg_id", "ref_id", "sigma_pct", "mu_pct", "hub_height",
        ...
        ttk.Label(bottom_bar, text="TR_v2.0 (Multi-Reference)",
