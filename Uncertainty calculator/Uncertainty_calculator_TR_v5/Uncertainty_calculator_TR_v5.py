...
class CalculatorApp:
    def __init__(self, root):
        self.root = root
        self.root.title("WS Horizontal Uncertainty Calculator — TR_v5 (adaptive roughness, sigma-only)")
    ...
    def _build_ui(self):
        ...
        cols = ("wtg_id", "ref_id", "sigma_pct", "sigma_self_pct", "overall_z",
                "hub_height", "distance_km", "dz_m",
                "dist_sat", "turning", "speedup", "sat_A", "sat_B", "dz_sat_val")
        ...
        headers = {
            ...
            "sigma_self_pct":  ("Self-pred sigma (%)", 130),
            ...
            "turning":         ("turning",             65),
            "speedup":         ("speedup",             65),
            "sat_A":           ("rough sat_A",         75),
            "sat_B":           ("rough sat_B",         75),
