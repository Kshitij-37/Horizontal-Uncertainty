...
output_dir = r"C:\Kshitij stuff\Horizontal Uncertainty Check\Output without graphs"
...
if WRITE_COLLECTED_EXCEL:
    ...
    search_dir = r"C:\Kshitij stuff\Horizontal Uncertainty Check\Output without graphs"
    ...
    output_path = rf"C:\Kshitij stuff\Horizontal Uncertainty Check\Output without graphs\Collected output_{today}.xlsx"
