...
calculated_data = str(latest)

print(f"Using following Output file as input data: {calculated_data}")
...
windspeed_energy_distribution = _cfg["directional_analysis_dir"]
TI_PATH = os.path.join(_cfg["input_data_dir"], "Turbulence Intensity.xlsx")
weibull_data = os.path.join(_cfg["input_data_dir"], "Weibull_parameters.xlsx")
...
output_path = os.path.join(_cfg["input_data_dir"], "Basis_of_input.xlsx")
...
sector_model_path = os.path.join(_cfg["input_data_dir"], "Focused_modelling_inputs.xlsx")
